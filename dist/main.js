...
Main.main = function() {
	...
	expressWs.app.ws("/",function(socket,req1) {
		var username = null;
		console.log("src/Main.hx:78:","User connected");
		...
		socket.on("message",function(msg) {
			console.log("src/Main.hx:107:","message: " + Std.string(msg));
			if(username == null) {
				...
				if(__map_reserved[key] != null ? _this.existsReserved(key) : _this.h.hasOwnProperty(key)) {
					...
					console.log("src/Main.hx:118:","User authenticated : " + username);
				} else {
					console.log("src/Main.hx:120:","Please provide a ticket first to log in.");
	...
	server.post("/login",function(expressReq,res1) {
		...
		if(uname == null || pwd == null) {
			...
			db_User.userExists(connection,username1,password,function(result) {
				...
				case 0:
					db_Token.createToken(connection,username1,59,function(createTokenResult) {
						...
						case 1:
							...
							console.log("src/Main.hx:190:",err);
				...
				case 3:
					var err1 = result.err;
					console.log("src/Main.hx:182:",err1);
		...
		if(username2 == null || password1 == null || email == null) {
			...
			db_User.userExists(connection,username3,password2,function(result1) {
				...
				case 3:
					...
					console.log("src/Main.hx:234:",err3);
	...
	server.listen(port);
	console.log("src/Main.hx:404:","Server running at http://localhost:" + port + "/");
	var onSigterm = function() {
		console.log("src/Main.hx:406:","Got SIGTERM. Graceful shutdown start");
	};
